...
- **主題分類**：B. 機器學習預測
- **BibTeX keys**：`cureus2024mlckd`, `song2020mlmeta`, `bai2022mlesrd`
...
2. **Meta-analysis（Song 等 2020）** — ML algorithms' accuracy in predicting kidney disease progression.
...
- **表現**：ESRD 預測 AUROC 約 **0.84–0.89**；all-cause mortality 較低（約 0.75–0.77）。
